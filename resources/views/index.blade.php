    ...
    <div class="ideas-container space-y-6 my-6">
        ...
        <div
            ...
            <div class="hidden md:block border-r border-gray-100 px-5 py-8">
                ...
                <div class="mt-8">
                    <button
                        class="w-20 bg-blue text-white font-bold text-xxs border border-gray-200 hover:border-gray-400 transition duration-150 ease-in uppercase rounded-xl px-4 py-4">Vote</button>
                </div>
            </div>
            <div class="flex flex-1 flex-col md:flex-row px-2 py-6">
                <div class="flex-none mx-2 md:mx-0">
                ...
                <div class="w-full flex flex-col justify-between mx-4">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2 mt-4 md:mt-0" x-data="{ isOpen: false }">
                            <div
                                class="bg-yellow text-xxs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4 hover:bg-gray-300 transition duration-150 ease-in">
                                In Progress</div>
                            <button @click="isOpen = !isOpen"
                                class="relative bg-gray-100 hover:bg-gray-200 rounded-full h-7 transition duration-150 ease-in border py-2 px-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="16"
            ...
            <div class="flex flex-1 flex-col md:flex-row px-2 py-6">
                ...
                <div class="w-full flex flex-col justify-between mx-4">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2 mt-4 md:mt-0" x-data="{ isOpen: false }">
                            <div
                                class="bg-red text-xxs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4 hover:bg-gray-300 transition duration-150 ease-in">
                                Closed</div>
                            <button @click="isOpen = !isOpen"
                                class="relative bg-gray-100 hover:bg-gray-200 rounded-full h-7 transition duration-150 ease-in border py-2 px-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="16"
            ...
            <div class="flex flex-1 flex-col md:flex-row px-2 py-6">
                ...
                <div class="w-full flex flex-col justify-between mx-4">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2 mt-4 md:mt-0" x-data="{ isOpen: false }">
                            <div
                                class="bg-green text-xxs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4 hover:bg-gray-300 transition duration-150 ease-in">
                                Implemented</div>
                            <button @click="isOpen = !isOpen"
                                class="relative bg-gray-100 hover:bg-gray-200 rounded-full h-7 transition duration-150 ease-in border py-2 px-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="16"
            ...
            <div class="flex flex-1 flex-col md:flex-row px-2 py-6">
                ...
                <div class="w-full flex flex-col justify-between mx-4">
                    ...
                    <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                        ...
                        <div class="flex items-center space-x-2 mt-4 md:mt-0" x-data="{ isOpen: false }">
                            <div
                                class="bg-purple text-xxs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4 hover:bg-gray-300 transition duration-150 ease-in">
                                Considering</div>
                            <button @click="isOpen = !isOpen"
                                class="relative bg-gray-100 hover:bg-gray-200 rounded-full h-7 transition duration-150 ease-in border py-2 px-4">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="16"
